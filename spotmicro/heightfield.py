...
# Toggle this between useProgrammatic and useTerrainFromPNG to get
# flat vs. rocky terrain. Both examples have a sphere to follow
    ...
    def _generate_field(self, env, heightPerturbationRange=0.08):
        ...
        if heightfieldSource == useProgrammatic:
            ...
            env.pybullet_client.changeDynamics(terrain,
                                               -1,
                                               lateralFriction=1.0)
            # If sphere is not wanted comment out this and the following block
            sphere_id = env.pybullet_client.loadURDF(
                "sphere_small.urdf",
                basePosition=[0, 0, 1],
        ...
        if heightfieldSource == useTerrainFromPNG:
            ...
            print(f"Loaded sphere ID: {sphere_id}")
